...
class Config:
    ...
    # Master switch for data sourcing:
    # True  -> employees, vehicles, and drivers are loaded/reused from DB
    # False -> employees, vehicles, and drivers are generated from scratch each run
    LOAD_ALL_FROM_DB: bool = True
